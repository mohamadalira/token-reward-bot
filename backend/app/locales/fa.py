...
MESSAGES = {
    ...
    "sponsor_intro": (
        "💼 پنل اسپانسری\n\n"
        "کانال خودت رو تبلیغ کن و با هر عضو جدید توکن هدیه بده 🚀"
    ),
    "sponsor_menu": "💼 پنل اسپانسری",
    "sponsor_guide": (
        "📚 راهنمای اسپانسر\n\n"
        "🎁 توکن چیست؟\n"
        "واحد پول داخل ربات — برای پاداش عضو و خرید کانفیگ.\n\n"
        "📢 تبلیغ چگونه کار می‌کند؟\n"
        "کانال ثبت می‌کنی، پاداش هر عضو را مشخص می‌کنی، "
        "کاربران با عضویت توکن می‌گیرند.\n\n"
        "💵 قیمت هر توکن: {token_price} تومان\n\n"
        "💰 شارژ کیف پول:\n"
        "از منوی پنل → شارژ کیف پول → تعداد توکن → روش پرداخت → ارسال رسید\n\n"
        "🚀 ساخت کمپین:\n"
        "کانال → تست دسترسی ربات → پاداش → بودجه → تایید\n\n"
        "👥 کسب عضو:\n"
        "کمپین فعال = کانال در لیست تسک‌های کاربران نمایش داده می‌شود."
    ),
    "sponsor_dashboard": (
        "💼 پنل اسپانسری\n\n"
        "{wallet}\n\n"
        ...
        "📦 بودجه باقی‌مانده: {remaining} توکن\n"
    ...
    "sponsor_approved": "به پنل اسپانسری خوش اومدی ✅",
    "sponsor_rejected": "درخواست اسپانسری رد شد ❌",
    "campaign_created": "کمپین ساخته شد ✅",
    "campaign_created_active": "کمپین با موفقیت فعال شد ✅",
    "campaign_exhausted": (
        "⚠️ بودجه کمپین تمام شد.\n"
        "برای ادامه کیف پول را شارژ کن."
    ),
    ...
    "wallet_deposit_approved": "✅ شارژ کیف پول تایید شد\n🎁 {amount} توکن به حسابت اضافه شد",
    "wallet_deposit_rejected": "❌ درخواست شارژ کیف پول رد شد",
